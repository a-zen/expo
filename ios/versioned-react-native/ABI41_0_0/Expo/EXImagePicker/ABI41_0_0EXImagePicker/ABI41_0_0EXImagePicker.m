#import <ABI41_0_0EXImagePicker/ABI41_0_0EXImagePicker.h>
#import <ABI41_0_0EXImagePicker/ABI41_0_0EXImagePickerCameraPermissionRequester.h>
...
const CGFloat ABI41_0_0EXDefaultImageQuality = 0.2;

@interface ABI41_0_0EXImagePicker ()
...
@implementation ABI41_0_0EXImagePicker

ABI41_0_0UM_EXPORT_MODULE(ExponentImagePicker);
...
- (void)setModuleRegistry:(ABI41_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  _permissionsManager = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0UMPermissionsInterface)];
  [ABI41_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI41_0_0EXImagePickerCameraPermissionRequester new],
                                                    [ABI41_0_0EXImagePickerMediaLibraryPermissionRequester new],
                                                    [ABI41_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester new]
                                                    ]
...
{
  if (writeOnly) {
    return [ABI41_0_0EXImagePickerMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI41_0_0EXImagePickerMediaLibraryPermissionRequester class];
  }
}

ABI41_0_0UM_EXPORT_METHOD_AS(getCameraPermissionsAsync,
                    getCameraPermissionsAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  [ABI41_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI41_0_0EXImagePickerCameraPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI41_0_0UM_EXPORT_METHOD_AS(getMediaLibraryPermissionsAsync,
...
ABI41_0_0UM_EXPORT_METHOD_AS(requestCameraPermissionsAsync,
                    requestCameraPermissionsAsync:(ABI41_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
...
ABI41_0_0UM_EXPORT_METHOD_AS(requestMediaLibraryPermissionsAsync,
...
ABI41_0_0UM_EXPORT_METHOD_AS(launchCameraAsync, launchCameraAsync:(NSDictionary *)options
                  resolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  ...
  BOOL permissionsAreGranted = [self hasCameraRollPermission] &&
                               [self.permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI41_0_0EXImagePickerCameraPermissionRequester class]];
  ...
  self.reject = reject;
  [self launchImagePicker:ABI41_0_0EXImagePickerTargetCamera options:options];
}

ABI41_0_0UM_EXPORT_METHOD_AS(launchImageLibraryAsync, launchImageLibraryAsync:(NSDictionary *)options
                  resolver:(ABI41_0_0UMPromiseResolveBlock)resolve
                  rejecter:(ABI41_0_0UMPromiseRejectBlock)reject)
{
  if (!_permissionsManager) {
  ...
  self.resolve = resolve;
  self.reject = reject;
  [self launchImagePicker:ABI41_0_0EXImagePickerTargetLibrarySingleImage options:options];
}

- (void)launchImagePicker:(ABI41_0_0EXImagePickerTarget)target options:(NSDictionary *)options
{
...
- (void)launchImagePicker:(ABI41_0_0EXImagePickerTarget)target
{
  dispatch_async(dispatch_get_main_queue(), ^{
    self.picker = [UIImagePickerController new];

    if (target == ABI41_0_0EXImagePickerTargetCamera) {
    ...
    id<ABI41_0_0UMUtilitiesInterface> utils = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0UMUtilitiesInterface)];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
  dispatch_block_t dismissCompletionBlock = ^{
    ...
    id<ABI41_0_0UMFileSystemInterface> fileSystem = [self.moduleRegistry getModuleImplementingProtocol:@protocol(ABI41_0_0UMFileSystemInterface)];
    if (!fileSystem) {
          ...
          completionHandler:(void (^)(void))completionHandler
{
  ...
  NSData *data = UIImageJPEGRepresentation(image, quality == nil ? ABI41_0_0EXDefaultImageQuality : [quality floatValue]);
  ...
  if ([[self.options objectForKey:@"exif"] boolValue]) {
    ...
    if (metadata) {
      ...
      if (!asset) {
        ABI41_0_0UMLogInfo(@"Could not fetch metadata for image %@", [imageURL absoluteString]);
        completionHandler();
      }
...
- (BOOL)hasCameraRollPermission
{
  ...
  return [_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI41_0_0EXImagePickerMediaLibraryPermissionRequester class]];
}
